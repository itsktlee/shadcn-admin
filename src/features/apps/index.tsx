            ...
            >
              <div className='mb-8 flex items-center justify-between'>
                ...
                <Button
                  ...
                  className={
                    app.connected
                      ? 'border-primary/25 bg-primary/10 text-primary hover:bg-primary/15 hover:text-primary dark:border-primary/35 dark:bg-primary/15 dark:hover:bg-primary/20'
                      : undefined
                  }
                >
